...
const weeklySchedule = {
    ...
    2: [
        ...
        { subject: "L/ECE1001/TD/CB512", time: "10:00 AM" },
    ...
    3: [
        // Wednesday
        { subject: "L/MTH1101/SDS/CB501", time: "10:50 PM" },
        { subject: "L/PHY1001/RC/CB501", time: "10:43 PM" },
        { subject: "L/ECE1001/TD/CB501", time: "10:46 PM" },
        { subject: "LAB/MEC1051/SH/RK,SC/CMEB06", time: "10:47 PM" },
    ],
    4: [
        // Thursday
...
Object.keys(weeklySchedule).forEach((dayOfWeek) => {
    weeklySchedule[dayOfWeek].forEach((classInfo) => {
        ...
        cron.schedule(
            `${notificationTime.minutes()} ${notificationTime.hours()} * * ${dayOfWeek}`,
            () => {
                bot.sendMessage(
                    chatId,
                    `🔔 Reminder: Your ${classInfo.subject} class is about to start at ${classInfo.time}.`,
                );
            },
            {
...
console.log(
    "Bot is running and will send notifications based on the predefined weekly schedule with Kolkata timezone.",
);
